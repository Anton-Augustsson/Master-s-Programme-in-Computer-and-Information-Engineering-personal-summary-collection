...
\begin{figure}[!h]
    \centering
    \includegraphics[width=12cm]{image/sampling_and_reconstruction.pdf}
...
\noindent We can do sampling in the time domain and in the frequncy domain. 
...
\begin{exampleblock}{Example: Determine how many samples is needed}
    ...
    \begin{equation*}
        x[k] = 0.5\cos(2\frac{2\pi}{10}k) + \cos(3\frac{3\pi}{10}k) \text{?}
    \end{equation*}
