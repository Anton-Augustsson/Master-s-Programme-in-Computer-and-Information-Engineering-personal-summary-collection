...
\begin{figure}[!h]
    \centering
    \includegraphics[width=12cm]{images/database-system.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=10cm]{images/notation-er-diagrams.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{images/crow_foot.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=8cm]{images/constraints_specialization-generalization.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=12cm]{images/sql_joins.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=12cm]{images/temporary_update_problem.png}
    \caption{Temporary update problem}
    \label{fig:temporary_update_problem}
\end{figure}
\begin{figure}[!h]
    \centering
    \includegraphics[width=12cm]{images/incorrect_summary_problem.png}
