...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/bayes_theorem.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/linear_vs_logistic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/svm_margins_in_2_dim.png}
    \caption{Bayes Theorem. From \cite{iml}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/bias_variance_trade_off.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/grid_search.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/k-nn.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/hierarchical_clustering.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/k-means.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/decision_trees.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/unfair_coin.png}
    \caption{Decision Trees. From \cite{iml}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/information_gain.png}
    \caption{Decision Trees. From \cite{iml}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/example_conditional_entropy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{\imagesPath/pca_demo.png}
